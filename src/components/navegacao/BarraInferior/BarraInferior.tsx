...
/**
 * BarraInferior — bottom navigation com pill destacando o item ativo (visual
 * inspirado no anexo 1).
 *
 * Layout: só ícones. Decisão consciente — em uma barra de 4-5 itens em mobile,
 * rótulos textuais espremem o tap target e poluem o visual; o ícone sozinho
 * já carrega o significado e o `accessibilityLabel` cobre leitor de tela.
 *
 * Microinterações:
 *  - Press scale 0.92 (Animated)
 *  - Item ativo ganha pill colorida + leve scale up
 *
 * `larguraMaxima` permite "estreitar" a barra em telas grandes (ex: tablet/web).
 */
